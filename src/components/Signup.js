    ...
    <div className='container mt-2'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="password" className="form-control" name="password" id="password" onChange={onChange} minLength={5} required />   {/* 👉 'minlength' and 'required' ata amar 'form' a 'onSubmit' dewar fole browser er inbuild validation function pai...  */}
        </div>
        <div className="mb-3">
